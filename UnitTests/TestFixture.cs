...
{
    /// <summary>
    /// This class provides a fixed state of a set of objects used as a baseline for running tests
    /// </summary>
    [SetUpFixture]
    public class TestFixture
    {
        ...
        /// <summary>
        /// This method runs once per test harness execution 
        /// to ensure unit test project to always reference the latest datasets
        /// </summary>
        [OneTimeSetUp]
