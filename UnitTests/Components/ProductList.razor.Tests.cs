...
namespace UnitTests.Components
{
    public class ProductListTests : BunitTestContext
    {
        ...
        public void SelectProduct_Valid_ID_kamonegi_Should_Return_Content()
        {
            // Arrange
            Services.AddSingleton<JsonFileProductService>(TestHelper.ProductService);
            var id = "MoreInfoButton_kamonegi";
        ...
        [Test]
        public void QuickLinkProduct_Valid_ID_kamonegi_Should_Return_Content()
        {
            // Arrange
            Services.AddSingleton<JsonFileProductService>(TestHelper.ProductService);
            var id = "QuickLinkButton_kamonegi";
            ...
            // Assert
            Assert.AreEqual(true, pageMarkup.Contains("Kamonegi"));
        }
        ...
        public void SubmitRating_Valid_ID_Click_Unstared_Should_Increment_Count_And_Check_Star()
        {
            ...
            */
            ...
            // Arrange
            Services.AddSingleton<JsonFileProductService>(TestHelper.ProductService);
            var id = "MoreInfoButton_ten sushi";
        ...
        public void SubmitRating_Valid_ID_Click_Stared_Should_Increment_Count_And_Leave_Star_Check_Remaining()
        {
            ...
            */
            ...
            // Confirm that the record had no votes to start, and 1 vote after
            Assert.AreEqual(true, preVoteCountString.Contains("2 Votes"));
            Assert.AreEqual(true, postVoteCountString.Contains("3 Votes"));
            Assert.AreEqual(false, preVoteCountString.Equals(postVoteCountString));
        }

        [Test]
        public void SubmitRating_Valid_ID_Click_Stared_Should_Increment_Star_Vote_To_Votes()
        {
            /*
             This test tests that the SubmitRating will change the vote as well as the Star checked
             Because the star check is a calculation of the ratings, using a record that has no stars and checking one makes it clear what was changed
            ...
            */
            ...
            // Arrange
            Services.AddSingleton<JsonFileProductService>(TestHelper.ProductService);
            var id = "MoreInfoButton_Momiji Capitol Hill";
